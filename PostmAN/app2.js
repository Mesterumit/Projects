...
//-this is the function that's going to display the student on a list 
//- the list you'll find in the index.html file
//-we are looping through the data in order to get what we want displayed 
//- first and last name, number and path or anything else that's available
...
//   this bit of code is what adds the data to the DOM via innerHTML - 
//  this is what allow us to see the data on the browser
  console.log(html)
  console.log(html.join(''))
  ulElm.innerHTML = html.join('')
}

// this is how we are getting this data 
//- notice that we are calling the getStudents function and 
// still using async/await because the original function is awaiting the axios API"
async function getData() {
  const data = await getStudents()
  displayStudents(data)
}

//this adds the event listener to the window open
// and displayed on the browser, not the entire document"
